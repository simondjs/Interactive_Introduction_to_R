...
This is an early version of an interactive approach to R tutorial design using the Shiny package. The final version will be longer and have more interactive functions.
  ...
  navbarPage("Introduction to R",
             ...
             tabPanel("Lesson 1",
                      sidebarPanel(
                        ...
                        "In its most basic form, R is a glorified calculator. Perform a calculation using + (addition), - (substraction), * (multiplication), or / (division) Give it a try in the box on the right. Look up more arithmetic operators or just follow this", tags$a(href="https://www.tutorialgateway.org/r-arithmetic-operators/", "link"), "if you're keen and try them out here! Once you're done, please proceed to Lesson 2",
                        width = 8
                      ),
                      mainPanel(
                        "",
